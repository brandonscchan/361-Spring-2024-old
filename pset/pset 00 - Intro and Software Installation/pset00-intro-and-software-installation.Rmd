...
![](img/snip of Brandon Chan's Course Survey.png)
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Brandon Chan's animation")
g
...
![](img/snip of Brandon Chan's test animation.png)
...
![](img/snip of Brandon Chan's GitHub Desktop.png)
